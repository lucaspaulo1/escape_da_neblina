...
$(OBJ)/%.o: $(SRC)/%.c $(wildcard $(INC)/*.h) | create_dirs
	$(CC) -g $(CFLAGS) -o $@ -c $<
...
# teste
gen: 
	@c++ -g ./src/no.c ./src/ponto.c ./src/lista_encadeada.c ./src/graph.c ./src/grafo_matriz_adjacencia.c ./src/fila_prioridade.c ./src/encontrar_caminho.c eique.c -o asdas
	@./asdas < lucas.txt
